...
impl Polygon {
	...
	/// Mark the vertices on the host as being outdated, because something on the GPU changed them.
	///
	/// This allows external code within this crate, such as the operations, to execute a GPU kernel
